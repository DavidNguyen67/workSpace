...
import { SVG_SIZE } from '@/utilities/constants';
...
function FormLogin() {
  ...
  const items: MenuProps['items'] = useMemo(
    () => [
      {
        label: (
          <Paragraph onClick={handleLoginByGoogle}>
            <GoogleIcon /> Login By Google
          </Paragraph>
        ),
        key: '1',
      },
      {
        label: (
          <Paragraph onClick={handleLoginByGithub}>
            <GithubIcon /> Login By Github
          </Paragraph>
        ),
        key: '2',
      },
    ],
    [handleLoginByGoogle, handleLoginByGithub]
  );
